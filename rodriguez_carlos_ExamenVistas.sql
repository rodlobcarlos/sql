...
-- Ejercicio 1
create user "banquero"@"localhost" identified by "contraseña";
grant select on banco.* to "banquero"@"localhost" with grant option;

-- Ejercicio 2
create view nombre_apellidos_sucursal as
select nombre, apellidos
from CLIENTE
where direccion =  'Ctra. De la Playa, 67';
select*from nombre_apellidos_sucursal;
...
-- Ejercicio 5
create view nombre_apellidos_direccion_usuarios as
select nombre, apellidos, direccion
from CLIENTE;
select*from nombre_apellidos_direccion_usuarios;

-- Ejercicio 6
create user "usuario_vistas"@"localhost" identified by "contraseña";
grant select on nombre_apellidos_sucursal to "usuario_vistas"@"localhost";
grant select on saldo_usuario to "usuario_vistas"@"localhost";
grant select on interes to "usuario_vistas"@"localhost";