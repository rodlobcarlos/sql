...
where direccion like"%A%" and capital_anio_anterior > 10.000;

-- Ejercicio 3
select*from MOVIMIENTO
where mes  = 1;

-- Ejercicio 4 // POR TERMINAR
select*from MOVIMIENTO
where FechaDate < "2007/3/3 12:45:00";

-- Ejercicio 5
select*from MOVIMIENTO
where cod_tipo_movimiento like "%S";
...
-- Ejercicio 7
select distinct cod_tipo_movimiento
from MOVIMIENTO;
